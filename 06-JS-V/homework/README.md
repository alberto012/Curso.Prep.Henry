...
* `prototype` es la base de donde las clases dan acceso a los metodos, es la fuente de las propiedades.
* _Constructors_ (de Clases) es un metodo que da inicio o crea los objetos a partir de una clase
